...
find /home/arpit20328/bracken_genome_size_estimations/seq_lengths/ -name "seq_length_taxon_*.txt" -exec bash -c 'taxid=$(basename "$1" .txt | sed "s/seq_length_taxon_//"); seq_length=$(grep -o "average:[0-9]*" "$1" | sed "s/average://"); echo -e "$taxid\t$seq_length"' _ {} \; > /home/arpit20328/bracken_genome_size_estimations/seq_lengths/taxon_seq_lengths_1.tsv
...
find -name "seq_length_taxon_*.txt" -exec bash -c 'taxid=$(basename "$1" .txt | sed "s/seq_length_taxon_//"); seq_length=$(grep -o "average:[0-9]*" "$1" | sed "s/average://"); echo -e "$taxid\t$seq_length"' _ {} \; >  /home/arpit20328/bracken_genome_size_estimations/files_having_zero_or_19_byte_size/seq_lengths/taxon_seq_lengths_2.tsv
